...
class Subcategory
{
    ...
    */
    ...
    public function __construct( $data=array() ) {
      if ( isset( $data['subcategory_id'] ) ) $this->id = (int) $data['subcategory_id'];
    ...
    */
    ...
    public function update() {
        ...
        $conn = new PDO( DB_DSN, DB_USERNAME, DB_PASSWORD );
        $sql = "UPDATE subcategories SET name=:name, category_id=:category_id, description=:description WHERE subcategory_id = :id";
        $st = $conn->prepare ( $sql );
        $st->bindValue( ":name", $this->name, PDO::PARAM_STR );
        $st->bindValue( ":category_id", $this->category_id, PDO::PARAM_INT );
        $st->bindValue( ":description", $this->description, PDO::PARAM_STR );
